                    ...
                    <div class="relative">
                        ...
                        <div id="login-form" class="absolute top-14 bg-white shadow-lg -ml-[10em] p-4 lg:p-8 w-[18em] sm:w-[24em] max-w-md lg:w-[120em] lg:h-[35em] hidden login-form mx-auto">
                            <div class="flex flex-col justify-center items-center">
                                <div class="p-3 w-full text-red-700 rounded flex items-center">
                                    <svg class="w-5 h-5 mr-2 text-red-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4m0 4h.01M19.07 4.93a10 10 0 11-14.14 0 10 10 0 0114.14 0z"></path>
                                    </svg>
                                    <span>We can't find that username and password. Try again.</span>
                                </div>
